...
/**
 * The administration side of the 2Checkout payment module
 */
 ...
 */
    ...
    function install() {
      ...
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) values ('Enable 2Checkout Payments', 'MODULE_PAYMENT_PM2CHECKOUT_STATUS', '-1', 'Do you want to accept 2Checkout payments?', '6', '0', 'osc_cfg_use_get_boolean_value', 'osc_cfg_set_boolean_value(array(1, -1))', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('2Checkout Seller ID', 'MODULE_PAYMENT_PM2CHECKOUT_SELLER_ID', '', 'Your 2Checkout Account Number.', '6', '0', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('2Checkout Secret Word', 'MODULE_PAYMENT_PM2CHECKOUT_SECRET_WORD', '', 'The secret word you set on the 2Checkout Site Management page.', '6', '0', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) values ('Demo Mode', 'MODULE_PAYMENT_PM2CHECKOUT_DEMO_MODE', '', 'Demo Mode?', '6', '0', 'osc_cfg_use_get_boolean_value', 'osc_cfg_set_boolean_value(array(1, -1))', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) values ('Direct Checkout', 'MODULE_PAYMENT_PM2CHECKOUT_DIRECT', '', 'Direct Checkout?', '6', '0', 'osc_cfg_use_get_boolean_value', 'osc_cfg_set_boolean_value(array(1, -1))', now())");
    ...
    function getKeys() {
      if (!isset($this->_keys)) {
        $this->_keys = array('MODULE_PAYMENT_PM2CHECKOUT_STATUS',
                             ...
                             'MODULE_PAYMENT_PM2CHECKOUT_DIRECT',
